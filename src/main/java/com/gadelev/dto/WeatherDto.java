...
public class WeatherDto {
    ...
    public WeatherDto(Integer id, String description, String humidity, String temp, String city, String email, LocalDateTime time) {
        this.id = id;
        this.description = description;
        this.humidity = humidity;
        this.temp = temp;
    ...
    public static WeatherDto fromModel(Weather weather) {
        return new WeatherDto(weather.getId(), weather.getDescription(), weather.getHumidity(),
                weather.getTemp(), weather.getCity(), weather.getEmail(),weather.getTime());
    }
}